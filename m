...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0BB1A64853F
	for <lists+linux-pm@lfdr.de>; Fri,  9 Dec 2022 16:27:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231201AbiLIP1M (ORCPT <rfc822;lists+linux-pm@lfdr.de>);
        Fri, 9 Dec 2022 10:27:12 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47428 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230441AbiLIP0m (ORCPT
        <rfc822;linux-pm@vger.kernel.org>); Fri, 9 Dec 2022 10:26:42 -0500
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7A936900F1
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=rHWML0DVxyW3qSwhb926uWR479TLlH5+3sLeLdSLAHA=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        h=from:from:sender:sender:reply-to:reply-to:subject:subject:date:date:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=rHWML0DVxyW3qSwhb926uWR479TLlH5+3sLeLdSLAHA=;
        b=nbTY2EnqHiHz5309Wkn+CX7bvj506Es88vkRx3QH5uhPWM6faCUEvDXYtQyyzuIHwlX5W3
        kMhOPfbY29tdntCw==
From:   "thermal-bot for Daniel Lezcano" <tip-bot2@linutronix.de>
Sender: tip-bot2@linutronix.de
Reply-to: linux-pm@vger.kernel.org
To:     linux-pm@vger.kernel.org
Subject: [thermal: thermal/next] thermal/intel/int340x: Replace parameter to simplify
Cc:     Daniel Lezcano <daniel.lezcano@linaro.org>,
        Srinivas Pandruvada <srinivas.pandruvada@linux.intel.com>,
        rui.zhang@intel.com, amitk@kernel.org
In-Reply-To: <20221003092602.1323944-29-daniel.lezcano@linaro.org>
References: <20221003092602.1323944-29-daniel.lezcano@linaro.org>
MIME-Version: 1.0
Message-ID: <167059959220.4906.14310209913702420115.tip-bot2@tip-bot2>
...
Commit-ID:     2f31c3f7aff30aeff127050b52135ad741963588
Gitweb:        https://git.kernel.org/pub/scm/linux/kernel/git/thermal/linux.git//2f31c3f7aff30aeff127050b52135ad741963588
Author:        Daniel Lezcano <daniel.lezcano@linaro.org>
AuthorDate:    Mon, 03 Oct 2022 11:26:01 +02:00
...
---
 drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.c     | 33 +++++++++++++++------------------
 drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.h     |  4 ++--
 drivers/thermal/intel/int340x_thermal/processor_thermal_device.c | 10 +++-------
 3 files changed, 20 insertions(+), 27 deletions(-)

diff --git a/drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.c b/drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.c
index 62c0aa5..228f442 100644
