...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BD68B610D95
	for <lists+linux-pm@lfdr.de>; Fri, 28 Oct 2022 11:45:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229631AbiJ1JpG (ORCPT <rfc822;lists+linux-pm@lfdr.de>);
        Fri, 28 Oct 2022 05:45:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52968 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229717AbiJ1Jox (ORCPT
        <rfc822;linux-pm@vger.kernel.org>); Fri, 28 Oct 2022 05:44:53 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C626320377
        for <linux-pm@vger.kernel.org>; Fri, 28 Oct 2022 02:44:48 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 408A26271D
        for <linux-pm@vger.kernel.org>; Fri, 28 Oct 2022 09:44:48 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 8D110C43470
        for <linux-pm@vger.kernel.org>; Fri, 28 Oct 2022 09:44:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1666950287;
        bh=dcVgBVWYm2CQTN5AJaDQDW7lUlw9Vx1V4OxXd5NoOYo=;
        h=References:In-Reply-To:From:Date:Subject:To:Cc:From;
        b=
Received: by mail-ej1-f53.google.com with SMTP id f27so11707461eje.1
        for <linux-pm@vger.kernel.org>; Fri, 28 Oct 2022 02:44:47 -0700 (PDT)
X-Gm-Message-State: ACrzQf1TMeBVr50ySSzHlfFc1lKIJJD9o94AxibV1ZYbBLxp3/p/1RC9
        wDzhUyNypm4/cX3ANUZ0YkrOqy2dK5fpGu9HZOc=
X-Google-Smtp-Source: AMsMyM4kQRSlu/ooyRCraWXHBySlGZ8Ve1LJE6p/jVSkTRD7LOnorNBAdQp6A2Jl1AT5cKGFkqgLPOpRw9uR674nxj8=
X-Received: by 2002:a17:907:3ea2:b0:7ad:86f9:7b15 with SMTP id
 hs34-20020a1709073ea200b007ad86f97b15mr8641506ejc.272.1666950285696; Fri, 28
 Oct 2022 02:44:45 -0700 (PDT)
MIME-Version: 1.0
References: <20221028023829.4030984-1-chenhuacai@loongson.cn>
 ...
 <90b19909-8261-7783-bb43-fff00f8a0bb1@loongson.cn>
In-Reply-To: <90b19909-8261-7783-bb43-fff00f8a0bb1@loongson.cn>
From:   Huacai Chen <chenhuacai@kernel.org>
Date:   Fri, 28 Oct 2022 17:44:33 +0800
X-Gmail-Original-Message-ID: <CAAhV-H4F-tyAWOH4eg=H8a4PD=UQtEAwJ0dpVTHUsqfu_BWwkg@mail.gmail.com>
Message-ID: <CAAhV-H4F-tyAWOH4eg=H8a4PD=UQtEAwJ0dpVTHUsqfu_BWwkg@mail.gmail.com>
...
> >   Hi, Jinyang,
> >
> > On Fri, Oct 28, 2022 at 3:23 PM Jinyang He <hejinyang@loongson.cn> wrot=
e:
...
> >>>    libs-$(CONFIG_EFI_STUB) +=3D $(objtree)/drivers/firmware/efi/libst=
ub/lib.a
> >>>
...
> >>> diff --git a/arch/loongarch/include/asm/acpi.h b/arch/loongarch/inclu=
de/asm/acpi.h
...
> >>>    };
> >>>
> >>> diff --git a/arch/loongarch/include/asm/loongson.h b/arch/loongarch/i=
nclude/asm/loongson.h
> >>> index 00db93edae1b..12494cffffd1 100644
> >>> --- a/arch/loongarch/include/asm/loongson.h
> >>> +++ b/arch/loongarch/include/asm/loongson.h
> >>> @@ -136,4 +136,7 @@ typedef enum {
> >>>    #define ls7a_writel(val, addr)      *(volatile unsigned int   *)TO=
_UNCACHE(addr) =3D (val)
> >>>    #define ls7a_writeq(val, addr)      *(volatile unsigned long  *)TO=
_UNCACHE(addr) =3D (val)
> >>>
...
> >>> diff --git a/arch/loongarch/include/asm/time.h b/arch/loongarch/inclu=
de/asm/time.h
...
> >>> diff --git a/arch/loongarch/kernel/time.c b/arch/loongarch/kernel/tim=
e.c
> >>> index 786735dcc8d6..a6576dea590c 100644
> >>> --- a/arch/loongarch/kernel/time.c
> >>> +++ b/arch/loongarch/kernel/time.c
> >>> @@ -115,12 +115,17 @@ static unsigned long __init get_loops_per_jiffy=
(void)
> >>>        return lpj;
> >>>    }
> >>>
...
> >>> diff --git a/arch/loongarch/power/Makefile b/arch/loongarch/power/Mak=
efile
...
> >>> diff --git a/arch/loongarch/power/platform.c b/arch/loongarch/power/p=
latform.c
> >>> new file mode 100644
...
> >>> +     status =3D acpi_evaluate_integer(NULL, "\\SADR", NULL, &suspend=
_addr);
> >>> +     if (ACPI_FAILURE(status) || !suspend_addr) {
> >>> +             pr_err("ACPI S3 is not support!\n");
> >>> +             return -1;
> >>> +     }
> >>> +     loongson_sysconf.suspend_addr =3D (u64)phys_to_virt(PHYSADDR(su=
spend_addr));
> >>> +#endif
> >>> +     return 0;
> >>> +}
...
> >>> diff --git a/arch/loongarch/power/suspend.c b/arch/loongarch/power/su=
spend.c
> >>> new file mode 100644
...
> >> Hi, Huacai,
> >>
> >> For loongarch_suspend_enter() and loongarch_wakeup_start(), it is bett=
er to
> >> make them be more like C-style, that means it could obey LoongArch-psA=
BI.
...
> >> loongarch_suspend_enter() to one function and using 'jirl a0, t0, 0' t=
o link
...
> > Thank you for your comments, but you may misunderstand something about =
S3.
...
> > 3, What means combine  loongarch_suspend_enter() and loongarch_suspend_=
enter()?
>
