Return-Path: <linux-pm+bounces-24484-lists+linux-pm=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pm@lfdr.de
Delivered-To: lists+linux-pm@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id DE36FA6E52E
	for <lists+linux-pm@lfdr.de>; Mon, 24 Mar 2025 22:11:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id DCF1E3AFC0A
	for <lists+linux-pm@lfdr.de>; Mon, 24 Mar 2025 21:07:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 16DDD1DB548;
	Mon, 24 Mar 2025 21:03:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b="k4hKcma+"
X-Original-To: linux-pm@vger.kernel.org
Received: from lamorak.hansenpartnership.com (lamorak.hansenpartnership.com [198.37.111.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 497001D63C2;
	Mon, 24 Mar 2025 21:02:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.37.111.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1742850179; cv=none; b=ZMVphRtyJ0yAJgIvbRddqE3vDyfap+Zhsx+N454asLwbWv2KKMkMX6XNMh/R82cMxrVEecMoEyurjtC/t6wtxaDt5yQYhBT14cCtRhdF5yyte18wtMVrvy0rTiz6Y2DnrIogwcOt4XJadau/BObIMFzsdg4kuJ8mTZsvkuhRY/c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1742850179; c=relaxed/simple;
	bh=t7hz9BbLGnItjqWA/PztpFHzK89XzHu40JaJrczBa/E=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=roqZP/1Ctl074FSDGrzQsYr3+ryiNCeCgj/DXdpRU6WPgVfGnzDU1ALLg3i8BZ3BpoIF5xHKfKGwcK1ujDMKGCORFMRw5XtpgPvIjngjyntnrQBgxi46T94p+cXlp3Gqo8lwa3sRv5p7oSTKIlgn2ZOH9EJECNMIth6dUrQGh04=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com; spf=pass smtp.mailfrom=HansenPartnership.com; dkim=pass (1024-bit key) header.d=hansenpartnership.com header.i=@hansenpartnership.com header.b=k4hKcma+; arc=none smtp.client-ip=198.37.111.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=HansenPartnership.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=HansenPartnership.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
	d=hansenpartnership.com; s=20151216; t=1742850175;
	bh=t7hz9BbLGnItjqWA/PztpFHzK89XzHu40JaJrczBa/E=;
	h=Message-ID:Subject:From:To:Date:In-Reply-To:References:From;
	b=k4hKcma+edeEUe/pMTJDOjv7I9zKS8FAA8vN/QFIUrIcH1Qd1Mp9n8qiWnd9kuwef
	 iUm47RlWXRhdEqXnQpfv37CPjlrPEmD4EahuKVCgP1q3OaPYkBuTmx+EvjI/HlCkkY
	 NaC5nsjcP6ZC2mk0J3aoYPmV6V6IpiSacUMXuync=
Received: from [172.22.32.239] (unknown [99.209.85.25])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange x25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by lamorak.hansenpartnership.com (Postfix) with ESMTPSA id 6C0991C0352;
	Mon, 24 Mar 2025 17:02:55 -0400 (EDT)
Message-ID: <7f3eddf89f8fd128ffeb643bc582e45a7d13c216.camel@HansenPartnership.com>
...
Date: Mon, 24 Mar 2025 17:02:54 -0400
...
> > > separate suspending user space processes from kernel ones.=C2=A0 The
> > > sync it currently does occurs before even user processes are
> > > frozen.=C2=A0 I think (as most of the original proposals did) that we
