Return-Path: <linux-pm+bounces-5526-lists+linux-pm=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pm@lfdr.de
Delivered-To: lists+linux-pm@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D4FA88ECC0
	for <lists+linux-pm@lfdr.de>; Wed, 27 Mar 2024 18:37:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 986BC1F27B8B
	for <lists+linux-pm@lfdr.de>; Wed, 27 Mar 2024 17:37:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 188CC14C58E;
	Wed, 27 Mar 2024 17:37:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=rjwysocki.net header.i=@rjwysocki.net header.b="CL9h+rGd"
X-Original-To: linux-pm@vger.kernel.org
Received: from cloudserver094114.home.pl (cloudserver094114.home.pl [79.96.170.134])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9ADD61327FA;
	Wed, 27 Mar 2024 17:37:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=79.96.170.134
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711561040; cv=none; b=USxm37ADKwwT/cr7xbggPudlpPO2JBmB612yreZtYnjc6bwWWSpUwnn4VBz38EVz9Nf1Vloogo+WhWMTm+dt1sK5sYOZDxo3Mhv3x9pd7j5STBkWjmqJ+XZbcpTFHIIqr/mL+QEzhx+YBsDtsn+gUaHrG3+caLxrV55P6yLXDeE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711561040; c=relaxed/simple;
	bh=KX4g13Xup63sTGBlrDCIfXNymgHLjpMxAiruTR8DQuM=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=T1mK88s53ccvQsPsUn7q0+ZcJR+ufSgMEe6jcVHy/kfCGfL20l4F80B2tPIpPyibIpne62VDkVGmh/NI9JU5V20qX7lsvyZoqqiHXhL1fFtwdyzVgVP/g6YsbKgyn5jjV9w45hBbHfCUe7SQRzwPy1gnpPVfJvJctxmKYMrOmIo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rjwysocki.net; spf=pass smtp.mailfrom=rjwysocki.net; dkim=fail (2048-bit key) header.d=rjwysocki.net header.i=@rjwysocki.net header.b=CL9h+rGd reason="signature verification failed"; arc=none smtp.client-ip=79.96.170.134
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rjwysocki.net
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=rjwysocki.net
Received: from localhost (127.0.0.1) (HELO v370.home.net.pl)
 by /usr/run/smtp (/usr/run/postfix/private/idea_relay_lmtp) via UNIX with SMTP (IdeaSmtpServer 6.0.0)
 id 51f46517d15d43b9; Wed, 27 Mar 2024 18:37:07 +0100
Received: from kreacher.localnet (unknown [195.136.19.94])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by cloudserver094114.home.pl (Postfix) with ESMTPSA id E6BCB66BFF7;
	Wed, 27 Mar 2024 18:37:06 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=rjwysocki.net;
	s=dkim; t=1711561027;
	bh=KX4g13Xup63sTGBlrDCIfXNymgHLjpMxAiruTR8DQuM=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References;
	b=
...
Subject:
 [Update][PATCH v2.1 1/3] thermal: core: Move threshold out of struct
 thermal_trip
Date: Wed, 27 Mar 2024 18:37:06 +0100
Message-ID: <5787324.DvuYhMxLoT@kreacher>
In-Reply-To: <1894658.tdWV9SEqCh@kreacher>
References: <2331888.ElGaqSPkdT@kreacher> <1894658.tdWV9SEqCh@kreacher>
Precedence: bulk
...
X-VADE-SPAMCAUSE: 
...
v2 -> v2.1:
   * Rebase on top of
     ...
     https://lore.kernel.org/linux-pm/20240325222424.4179635-1-daniel.lezca=
no@linaro.org/
