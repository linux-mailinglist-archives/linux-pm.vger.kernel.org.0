...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DEE931F90F
	for <lists+linux-pm@lfdr.de>; Wed, 15 May 2019 19:02:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727516AbfEORCc (ORCPT <rfc822;lists+linux-pm@lfdr.de>);
        Wed, 15 May 2019 13:02:32 -0400
Received: from mx1.redhat.com ([209.132.183.28]:60940 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726690AbfEORCc (ORCPT <rfc822;linux-pm@vger.kernel.org>);
        Wed, 15 May 2019 13:02:32 -0400
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com [10.5.11.14])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id 42B2C81E18;
        Wed, 15 May 2019 17:02:31 +0000 (UTC)
Received: from prarit.khw1.lab.eng.bos.redhat.com (prarit-guest.khw1.lab.eng.bos.redhat.com [10.16.200.63])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 83D2E5D9C3;
        Wed, 15 May 2019 17:02:30 +0000 (UTC)
From:   Prarit Bhargava <prarit@redhat.com>
To:     linux-pm@vger.kernel.org
Cc:     Prarit Bhargava <prarit@redhat.com>,
        Len Brown <len.brown@intel.com>,
        "Rafael J . Wysocki" <rafael.j.wysocki@intel.com>
Subject: [PATCH] x86/turbostat: Dynamically increase output buffer
Date:   Wed, 15 May 2019 13:02:27 -0400
Message-Id: <20190515170227.21673-1-prarit@redhat.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.14
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.25]); Wed, 15 May 2019 17:02:31 +0000 (UTC)
...
---
 tools/power/x86/turbostat/turbostat.c | 402 ++++++++++++++------------
...
@@ -807,80 +834,80 @@ int dump_counters(struct thread_data *t, struct core_data *c,
 	int i;
...
@@ -916,12 +943,12 @@ int format_counters(struct thread_data *t, struct core_data *c,
 		struct timeval tv;
...
@@ -930,108 +957,108 @@ int format_counters(struct thread_data *t, struct core_data *c,
...
@@ -1039,32 +1066,32 @@ int format_counters(struct thread_data *t, struct core_data *c,
 		goto done;
...
@@ -1078,9 +1105,9 @@ int format_counters(struct thread_data *t, struct core_data *c,
 		fmt8 = "%6.0f**";
...
@@ -1088,92 +1115,92 @@ int format_counters(struct thread_data *t, struct core_data *c,
...
@@ -5135,7 +5162,8 @@ int initialize_counters(int cpu_id)
