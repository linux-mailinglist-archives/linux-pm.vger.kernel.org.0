Return-Path: <linux-pm+bounces-2063-lists+linux-pm=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pm@lfdr.de
Delivered-To: lists+linux-pm@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E501829A6A
	for <lists+linux-pm@lfdr.de>; Wed, 10 Jan 2024 13:25:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id F124228526E
	for <lists+linux-pm@lfdr.de>; Wed, 10 Jan 2024 12:25:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EA76747774;
	Wed, 10 Jan 2024 12:25:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="VFMEtx+n"
X-Original-To: linux-pm@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2748A482C1
	for <linux-pm@vger.kernel.org>; Wed, 10 Jan 2024 12:25:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1704889517; x=1736425517;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=RXVsVknWEI0vAeuL2YO953GgozRbMYMql+pKuAW8Hvw=;
  b=VFMEtx+nf9kbcmFsrlzQnIIHXP6opV9g3tmP+AH/bi83I3+xumFqr29g
   4Opmx5awLdap01YHau4bVlcwfa13l9ve+bGD3XEQs9KOf/Jn+doZadKQe
   VboUSvOWluPSrBi73Mh+ssPuKLTk2pbqngNxHE5vg6zLgMh6pIP0qo9QY
   Sw1mSp5NLIpo22E2hUmYZm3TjOJIILSc3+i++jzjYgug9M3sEBPWjMigD
   7Fj52nPFgdzC/NWrNNdgx6B3xd6sZKylcj7aj2JbxhY3RF1Kai66Jne+M
   o5A2+ddBQb7hxGADJu4n/+/GAQR1p+n1hSI6+hTuO66ra2C/UTi9jcd6Y
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10948"; a="429683833"
X-IronPort-AV: E=Sophos;i="6.04,184,1695711600"; 
   d="scan'208";a="429683833"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Jan 2024 04:25:12 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.04,184,1695711600"; 
   d="scan'208";a="24253206"
Received: from turnipsi.fi.intel.com (HELO kekkonen.fi.intel.com) ([10.237.72.44])
  by smtpauth.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Jan 2024 04:25:08 -0800
Received: from svinhufvud.ger.corp.intel.com (localhost [IPv6:::1])
	by kekkonen.fi.intel.com (Postfix) with ESMTP id 6265511FAF9;
	Wed, 10 Jan 2024 14:25:04 +0200 (EET)
...
Subject: [PATCH v2 1/2] pm: runtime: Simplify pm_runtime_get_if_active() usage
Date: Wed, 10 Jan 2024 14:25:03 +0200
Message-Id: <20240110122503.143029-1-sakari.ailus@linux.intel.com>
