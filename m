...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 599A61865EB
	for <lists+linux-pm@lfdr.de>; Mon, 16 Mar 2020 08:49:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729946AbgCPHtv (ORCPT <rfc822;lists+linux-pm@lfdr.de>);
        Mon, 16 Mar 2020 03:49:51 -0400
Received: from szxga07-in.huawei.com ([45.249.212.35]:60652 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1729962AbgCPHtv (ORCPT <rfc822;linux-pm@vger.kernel.org>);
        Mon, 16 Mar 2020 03:49:51 -0400
Received: from DGGEMS409-HUB.china.huawei.com (unknown [172.30.72.59])
        by Forcepoint Email with ESMTP id A6CEC2B3EC7D3B6D4C80;
...
Subject: [PATCH 1/2] thermal: Add HiSilicon Kunpeng thermal driver
Date:   Mon, 16 Mar 2020 15:49:08 +0800
Message-ID: <1584344949-42011-2-git-send-email-shenyang39@huawei.com>
...
+	int ret;
+
+	tdev = devm_kzalloc(&pdev->dev, sizeof(* tdev) +
+			    sizeof(* tdev->tsensor) * num_tsensors, GFP_KERNEL);
+	if (!tdev)
+		return -ENOMEM;
+
