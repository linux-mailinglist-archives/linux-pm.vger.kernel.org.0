Return-Path: <linux-pm+bounces-41817-lists+linux-pm=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-pm@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qHS8MGZ9fWmGSQIAu9opvQ
	(envelope-from <linux-pm+bounces-41817-lists+linux-pm=lfdr.de@vger.kernel.org>)
	for <lists+linux-pm@lfdr.de>; Sat, 31 Jan 2026 04:56:22 +0100
X-Original-To: lists+linux-pm@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 16D25C099C
	for <lists+linux-pm@lfdr.de>; Sat, 31 Jan 2026 04:56:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 340053011F31
	for <lists+linux-pm@lfdr.de>; Sat, 31 Jan 2026 03:49:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 733A72DAFCC;
	Sat, 31 Jan 2026 03:49:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="NARkAAjK"
X-Original-To: linux-pm@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 49D2B1D5160;
	Sat, 31 Jan 2026 03:49:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1769831342; cv=none; b=DO2EHs+N69zmpI+IQBUfBzCCwQ+UgNBAjGBu131lTWn13PdYtRNW4v2mfoTDCgAaRcZDxAYWKK8VKdxjJIvzhz9a7zQ9zJ03SC/iF942CgQSMlEGYO7QUixK5eg1LobNLGxJnATTSJSZpMRe2A5Rmj1ZMLoq9fzcFYHD4NvGreM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1769831342; c=relaxed/simple;
	bh=ntwCR/7kKhAYrdKEF+wxEK50CCfLyKabkPM+HkqPNBQ=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=VR1Jz0uYWuQ/YySMh5TRXuNk8V4EwldauMy2hCmGvl+uyuOHp1TPrNQcqF59W8LIHZn6qWKrEb4nhcDa9kOxMIOGc+maCWd+WKTSRs3EYVlZW9EiptA6tiBwqzuPSx9UPWbjma0KL5cDkI1RqlPpOoj2uUBN2bP8kSZH4SH/TYw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=NARkAAjK; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id DD837C19421;
	Sat, 31 Jan 2026 03:49:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1769831341;
	bh=ntwCR/7kKhAYrdKEF+wxEK50CCfLyKabkPM+HkqPNBQ=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id CFFEAD73EB5;
	Sat, 31 Jan 2026 03:49:01 +0000 (UTC)
From: Michael Reeves via B4 Relay <devnull+michael.reeves077.gmail.com@kernel.org>
Date: Sat, 31 Jan 2026 14:48:56 +1100
Subject: [PATCH v7 1/2] power: supply: Add macsmc-power driver for Apple
 Silicon
Precedence: bulk
...
Message-Id: <20260131-b4-macsmc-power-v7-1-0e3a2da69948@gmail.com>
...
X-Mailer: b4 0.14.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1769831340; l=30502;
 i=michael.reeves077@gmail.com; s=20260105; h=from:subject:message-id;
 bh=92VnRrAhOUC/9bJmtfmJ2QoqgsS4XH8RKSxKSvcNcLc=;
 b=rAtgiuQ+R8/7D6fQwznv9dqot4Jb2wQOynvfoOqWug0WSowcZhE86AqEk6gU8yu7KecyB1/Jl
 vaOUIPBOtKSA3cMD53KJKnHUfTWwXjQHblDKDsYDXyNlvIuvPvY62Y1
...
X-Spamd-Result: default: False [10.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-41817-lists,linux-pm=lfdr.de,michael.reeves077.gmail.com];
	RCVD_TLS_LAST(0.00)[];
	R_DKIM_ALLOW(0.00)[kernel.org:s=k20201202];
	DBL_BLOCKED_OPENRESOLVER(0.00)[marcan.st:email,arm.com:email,gompa.dev:email,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,jannau.net:email];
...
index 000000000000..33ca07460f3a
--- /dev/null
