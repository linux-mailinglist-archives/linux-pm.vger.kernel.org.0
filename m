Return-Path: <linux-pm+bounces-41267-lists+linux-pm=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-pm@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id iGl+NaiucWlmLQAAu9opvQ
	(envelope-from <linux-pm+bounces-41267-lists+linux-pm=lfdr.de@vger.kernel.org>)
	for <lists+linux-pm@lfdr.de>; Thu, 22 Jan 2026 05:59:20 +0100
X-Original-To: lists+linux-pm@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [IPv6:2a01:60a::1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A41861DA2
	for <lists+linux-pm@lfdr.de>; Thu, 22 Jan 2026 05:59:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 85FB2527830
	for <lists+linux-pm@lfdr.de>; Thu, 22 Jan 2026 04:58:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2FAD14779AC;
...
X-Spamd-Result: default: False [3.04 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-41267-lists,linux-pm=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[amd.com:email,amd.com:dkim,amd.com:mid,fujitsu.com:email,huawei.com:email,intel.com:email,ams.mirrors.kernel.org:helo,ams.mirrors.kernel.org:rdns];
	FORGED_RECIPIENTS_MAILLIST(0.00)[];
	ASN(0.00)[asn:7979, ipnet:2a01:60a::/32, country:US];
	RCVD_COUNT_SEVEN(0.00)[7]
X-Rspamd-Queue-Id: 4A41861DA2
