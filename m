...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DC4543B2B5F
	for <lists+linux-pm@lfdr.de>; Thu, 24 Jun 2021 11:27:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231932AbhFXJ3o (ORCPT <rfc822;lists+linux-pm@lfdr.de>);
        Thu, 24 Jun 2021 05:29:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59662 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230438AbhFXJ3n (ORCPT
        <rfc822;linux-pm@vger.kernel.org>); Thu, 24 Jun 2021 05:29:43 -0400
Received: from desiato.infradead.org (desiato.infradead.org [IPv6:2001:8b0:10b:1:d65d:64ff:fe57:4e05])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F0EEFC061756;
        Thu, 24 Jun 2021 02:27:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=desiato.20200630; h=Content-Type:MIME-Version:References:
        Subject:Cc:To:From:Date:Message-ID:Sender:Reply-To:Content-Transfer-Encoding:
        Content-ID:Content-Description:In-Reply-To;
        bh=HBBI7MU9UmPvsF0YRhKxImPHeQWgam/ZxTUcjBJ/FIg=; b=HLJgLnWXcyK2pN9Rc6wBojdBAh
        ;
Received: from j217100.upc-j.chello.nl ([24.132.217.100] helo=noisy.programming.kicks-ass.net)
        by desiato.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1lwLdW-00BBs1-Mw; Thu, 24 Jun 2021 09:27:09 +0000
Received: from hirez.programming.kicks-ass.net (hirez.programming.kicks-ass.net [192.168.1.225])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (Client did not present a certificate)
        by noisy.programming.kicks-ass.net (Postfix) with ESMTPS id D00D530031C;
        Thu, 24 Jun 2021 11:27:07 +0200 (CEST)
Received: by hirez.programming.kicks-ass.net (Postfix, from userid 0)
        id B2EBC2B64C074; Thu, 24 Jun 2021 11:27:07 +0200 (CEST)
Message-ID: <20210624092616.009504322@infradead.org>
User-Agent: quilt/0.66
Date:   Thu, 24 Jun 2021 11:22:00 +0200
...
Subject: [PATCH v2 4/4] freezer,sched: Rewrite core freezer logic
...
---
 ...
 33 files changed, 259 insertions(+), 402 deletions(-)
...
@@ -7298,7 +7299,8 @@ nfs4_retry_setlk_simple(struct nfs4_stat
...
+		schedule_timeout(timeout);
 		...
 		status = -ERESTARTSYS;
@@ -7366,10 +7368,8 @@ nfs4_retry_setlk(struct nfs4_state *stat
 			break;
...
+#define __TASK_FROZEN_SPECIAL		0x008000
...
@@ -1590,7 +1599,6 @@ extern struct pid *cad_pid;
...
@@ -1602,7 +1610,6 @@ extern struct pid *cad_pid;
...
--- a/kernel/fork.c
+++ b/kernel/fork.c
@@ -1270,13 +1270,12 @@ static void complete_vfork_done(struct t
...
@@ -52,41 +53,41 @@ bool freezing_slow_path(struct task_stru
 }
...
@@ -101,6 +102,43 @@ static void fake_signal_wake_up(struct t
 	}
 }
...
@@ -137,19 +163,53 @@ bool freeze_task(struct task_struct *p)
...
+static void __thaw_special(struct task_struct *p)
+{
...
+		goto unlock;
+
+	if (READ_ONCE(p->__state) & __TASK_FROZEN_SPECIAL)
+		__thaw_special(p);
+
...
@@ -5875,7 +5875,7 @@ static void __sched notrace __schedule(b
...
--- a/kernel/signal.c
+++ b/kernel/signal.c
@@ -2281,7 +2281,7 @@ static void ptrace_stop(int exit_code, i
 		read_unlock(&tasklist_lock);
 		cgroup_enter_frozen();
...
+		schedule();
 		...
 		/*
@@ -2461,7 +2461,7 @@ static bool do_signal_stop(int signr)
...
+		schedule();
 		...
 		/*
@@ -2537,11 +2537,11 @@ static void do_freezer_trap(void)
...
@@ -3585,9 +3585,9 @@ static int do_sigtimedwait(const sigset_
 		recalc_sigpending();
...
@@ -2191,13 +2191,14 @@ static long unix_stream_data_wait(struct
...
+		prepare_to_wait(sk_sleep(sk), &wait, state);
 		...
 		if (tail != last ||
@@ -2210,10 +2211,7 @@ static long unix_stream_data_wait(struct
