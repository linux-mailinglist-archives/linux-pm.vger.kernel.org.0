Return-Path: <linux-pm+bounces-31473-lists+linux-pm=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pm@lfdr.de
Delivered-To: lists+linux-pm@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 78509B138F2
	for <lists+linux-pm@lfdr.de>; Mon, 28 Jul 2025 12:29:51 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A0C3B174151
	for <lists+linux-pm@lfdr.de>; Mon, 28 Jul 2025 10:29:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D917B246BC5;
	Mon, 28 Jul 2025 10:29:47 +0000 (UTC)
X-Original-To: linux-pm@vger.kernel.org
Received: from mailgw.kylinos.cn (mailgw.kylinos.cn [124.126.103.232])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6D7AC262BE
	for <linux-pm@vger.kernel.org>; Mon, 28 Jul 2025 10:29:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=124.126.103.232
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1753698587; cv=none; b=gIkXMQY63yeaE8dNuURh/9Din2ZvVPK9yVNHCgSNcr/5Sgqx0SddUwjYeLM8psMXb7IW71R/fFPH7VUK2kTXAML2Kd/2+GpvNTiiq83TW4Q1S47Qvu8ulheWHSgVfveVwzGYT3cz9tn5RUkXdvt5xjvAZ7v1ep6C373Htg78tPI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1753698587; c=relaxed/simple;
	bh=gFq12/h8dx3LpJoTPQ0dgJg4NIOgpimk1HJcU0bb/f4=;
	h=Message-ID:Subject:From:To:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=oHrSr8mPSfRLHqkK+S7XpBv6NPC/Aj9lR046f/gaSBmr5YRXhBWzF4jJQutKpVSQjAPS3Dmd8530CjLFPaX6JZMUY7yABKllW0S4VqbKrjBzjnlBKGIcbZVw8o8ek/DEG71uIgxUvrNSehR9nRV4GwCUJI2O23MqzuKeGDaP8GI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kylinos.cn; spf=pass smtp.mailfrom=kylinos.cn; arc=none smtp.client-ip=124.126.103.232
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kylinos.cn
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=kylinos.cn
X-UUID: c43921e06b9d11f0b29709d653e92f7d-20250728
X-CTIC-Tags:
	HR_CHARSET, HR_CHARSET_NUM, HR_CTE_8B, HR_CTT_TXT, HR_DATE_H
	HR_DATE_WKD, HR_DATE_ZONE, HR_FROM_DIGIT_LEN, HR_FROM_NAME, HR_SJ_CHARSET
	HR_SJ_DIGIT_LEN, HR_SJ_LANG, HR_SJ_LEN, HR_SJ_LETTER, HR_SJ_NOR_SYM
	HR_SJ_PHRASE, HR_SJ_PHRASE_LEN, HR_SJ_WS, HR_TO_COUNT, HR_TO_DOMAIN_COUNT
	HR_TO_NAME, HR_TO_NO_NAME, IP_TRUSTED, SRC_TRUSTED, DN_TRUSTED
...
X-CID-O-INFO: VERSION:1.1.45,REQID:2bc927e7-114d-402c-b663-81b1f00c8b25,IP:10,
	URL:0,TC:0,Content:7,EDM:0,RT:0,SF:-40,FILE:0,BULK:0,RULE:Release_Ham,ACTI
	ON:release,TS:-23
X-CID-INFO: VERSION:1.1.45,REQID:2bc927e7-114d-402c-b663-81b1f00c8b25,IP:10,UR
	L:0,TC:0,Content:7,EDM:0,RT:0,SF:-40,FILE:0,BULK:0,RULE:Release_Ham,ACTION
	:release,TS:-23
X-CID-META: VersionHash:6493067,CLOUDID:92e9bcef958c1ccfe51bdbb5c07cd7cd,BulkI
	D:250728182941CTXQONF1,BulkQuantity:0,Recheck:0,SF:10|24|38|44|64|66|78|80
...
Received: from [192.168.31.86] [(223.70.159.239)] by mailgw.kylinos.cn
	...
	with ESMTP id 1370486702; Mon, 28 Jul 2025 18:29:39 +0800
Message-ID: <12fa931e302340e5b80d6a116de9513f1b08d18e.camel@kylinos.cn>
Subject: =?gb2312?Q?Re=A3=BA=5BPATCH?= v2] hiberbate: init image_size depend
 on totalram_pages
From: lijun <lijun01@kylinos.cn>
To: "Rafael J. Wysocki" <rafael@kernel.org>, linux-pm@vger.kernel.org, 
	lijun01@kylinos.cn
Date: Mon, 28 Jul 2025 18:29:35 +0800
...
I am sorry for the mistake I made in version v2. I have made
the necessary modifications and have already sent version v3. 
...
current physical memory will definitely be greater than 16GB. If it is
32GB,
the current image_size will be initialized to 1/10 of the
totalram_mages().
...
is 64GB, the currentimage_size will be initialized to 1/20 of the
totalram_mages().
   This way, when there are  16GB ,32GB or 64GB, the size of the image
size will be controlled to be slightly more than 3G.
