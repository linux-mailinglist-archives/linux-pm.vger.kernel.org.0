...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 342514045A4
	for <lists+linux-pm@lfdr.de>; Thu,  9 Sep 2021 08:33:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234638AbhIIGer (ORCPT <rfc822;lists+linux-pm@lfdr.de>);
        Thu, 9 Sep 2021 02:34:47 -0400
Received: from mga07.intel.com ([134.134.136.100]:39971 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229605AbhIIGer (ORCPT <rfc822;linux-pm@vger.kernel.org>);
        Thu, 9 Sep 2021 02:34:47 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10101"; a="284401947"
X-IronPort-AV: E=Sophos;i="5.85,279,1624345200"; 
   d="scan'208";a="284401947"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Sep 2021 23:33:37 -0700
X-IronPort-AV: E=Sophos;i="5.85,279,1624345200"; 
   d="scan'208";a="539419056"
Received: from fenghuah-mobl.ccr.corp.intel.com ([10.255.29.189])
  by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Sep 2021 23:33:36 -0700
Message-ID: <992e20ba483a3838b7879209c8fd8dcf7e612731.camel@intel.com>
Subject: Re: [PATCH] thermal: int340x: fix tcc offset on resume
From:   Zhang Rui <rui.zhang@intel.com>
To:     Antoine Tenart <atenart@kernel.org>, daniel.lezcano@linaro.org,
        amitk@kernel.org, srinivas.pandruvada@linux.intel.com
Cc:     linux-pm@vger.kernel.org
Date:   Thu, 09 Sep 2021 14:33:33 +0800
...
> due
> to commit fe6a6de6692e ("thermal/drivers/int340x/processor_thermal:
> Fix tcc setting").
> 
...
> does fixes the issue and helps to start a discussion. If the fix
> looks
...
> +++
> b/drivers/thermal/intel/int340x_thermal/processor_thermal_device.h
> @@ -83,6 +83,7 @@ void proc_thermal_mbox_remove(struct pci_dev
> *pdev);
>  int processor_thermal_send_mbox_cmd(struct pci_dev *pdev, u16
> cmd_id, u32 cmd_data, u32 *cmd_resp);
...
> b/drivers/thermal/intel/int340x_thermal/processor_thermal_device_pci.
> c
> @@ -314,6 +314,20 @@ static void proc_thermal_pci_remove(struct
> pci_dev *pdev)
>  }
>  
>  #ifdef CONFIG_PM_SLEEP
...
>  {
>  	struct pci_dev *pdev = to_pci_dev(dev);
> @@ -335,10 +349,12 @@ static int proc_thermal_pci_resume(struct
> device *dev)
>  	return 0;
>  }
>  #else
